...
import nf.framework.video.mainui.MediaInfoActivity;
import nf.framework.video.mainui.VideoPlayerActivity;
import nf.framework.video.utils.Thumbnailer;
import nf.framework.video.vlc.Media;
import nf.framework.video.vlc.MediaDatabase;
import nf.framework.video.vlc.MediaGroup;
import nf.framework.video.vlc.MediaLibrary;
import nf.framework.video.vlc.Util;
import nf.framework.video.vlc.VlcRunnable;
import nf.framework.video.vlc.WeakHandler;
import nf.framework.video.vlc.adapter.VideoListAdapter;
import nf.framework.video.vlc.gui.CommonDialogs;
import nf.framework.video.vlc.interfaces.ISortable;
...
public class VideoFragment extends GridFragment implements ISortable {
