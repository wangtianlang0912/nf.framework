...
package nf.framework.video.vlc;
...
//    }
     ...
     * @return
     */
    public static ArrayList<String> getExpandStorageDirectories()
    {
    	ArrayList<String> list = new ArrayList<String>();
        BufferedReader bufReader = null;
        try {
    ...
    public static List<String> getStoragePaths(Context cxt) {
        ...
        if (android.os.Build.VERSION.SDK_INT < android.os.Build.VERSION_CODES.GINGERBREAD) {
            pathsList.addAll(getExpandStorageDirectories());
    ...
    public static String[] getMediaDirectories() {
        ArrayList<String> list = new ArrayList<String>();
        list.addAll(Util.getStoragePaths(VLCApplication.getAppContext()));
