...
public class InnerWebChromeClient extends WebChromeClient {
	...
	public boolean onJsAlert(WebView view, String url, String message,
		...
		final BaseDialog baseDialog =new BaseDialog(view.getContext(),AbsBaseDialog.DIALOG_BUTTON_STYLE_ONE);
		baseDialog.show();
	...
	public boolean onJsConfirm(WebView view, String url, String message,
			final JsResult result) {
		final BaseDialog baseDialog =new BaseDialog(view.getContext(),AbsBaseDialog.DIALOG_BUTTON_STYLE_TWO);
		baseDialog.show();
		baseDialog.setTitleText("提示");
		baseDialog.setContent(message);
		// 禁止响应按back键的事件
		...
		baseDialog.setDialogLeftBtnOnClickListener(new DialogLeftBtnOnClickListener() {
		...
		baseDialog.setDialogRightBtnOnClickListener(new DialogRightBtnOnClickListener() {
	...
	public boolean onJsPrompt(WebView view, String url, String message,
		...
		final EditTextDialog baseDialog =new EditTextDialog(view.getContext(),AbsBaseDialog.DIALOG_BUTTON_STYLE_TWO);
		baseDialog.show();
		baseDialog.setTitleText("提示");
